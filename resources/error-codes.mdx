---
title: "Buildmarkets API Error Codes: Full Reference Guide"
...
Every Buildmarkets API error follows the pattern `BLUM-{HTTP_STATUS}-{SEQUENCE}`. When a request fails, the response body includes the `code`, a human-readable `message`, and contextual detail. Use this reference to understand each code and resolve it quickly.

...
The TAPP Engine documentation describes two endpoints for managing brokerage documents. The platform stores "system-generated brokerage documents — account statements, trade confirmations, and tax forms" and provides access through discovery and retrieval endpoints.

...
<Note>
  **Ready to get started?** Log into the Buildmarkets Partner Dashboard to generate your API credentials, then build and test against the sandbox environment first.
</Note>

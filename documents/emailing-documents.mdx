...
The TAPP Engine documentation page explains how to deliver documents via email after retrieving them through the documents API.
...
This endpoint operates within the Documents section of TAPP Wealth, complementing related functionality for retrieving, uploading, and requesting documents.

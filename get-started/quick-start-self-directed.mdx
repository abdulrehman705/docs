---
title: "Quick Start: Self-Directed Investing with Bluum Finance"
...
<Steps>
  ...
  <Step title="Place a buy order">
    Once the deposit is `completed` and the wallet is funded, the user can trade. Bluum supports buying by quantity (whole shares) or by dollar amount (fractional shares).

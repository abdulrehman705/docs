...
**Example:**
```
8=FIX.4.4|9=72|35=A|34=1|49=CLIENT1|52=20260212-14:00:00.000|56=TAPPENGINE|98=0|108=60|10=123|
```
...
**Logout (MsgType = "5")**
```
8=FIX.4.4|9=56|35=5|34=150|49=CLIENT1|52=20260212-20:00:00.000|56=TAPPENGINE|10=045|
```
...
> **Recommendation:** "Avoid using the FIX Reject message. Per the FIX specification, any message you reject will **not** be resent." Instead, contact TAPP Engine support for unexpected message formats.

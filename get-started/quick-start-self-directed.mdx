...
description: "A step-by-step walkthrough to make your first authenticated TAPP Engine API call, open an account, fund it, place an order, and check positions."
---

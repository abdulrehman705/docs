---
title: "Bluum Finance API Glossary: Key Terms and Definitions"
sidebarTitle: "Glossary"
description: "Definitions for every term used across the Bluum Finance API — from accounts and wallets to IPS, KYC, and order time-in-force values."
---

This glossary defines the key terms used throughout Bluum's API, guides, and reference documentation. When you encounter an unfamiliar term in a response payload or endpoint description, look it up here.

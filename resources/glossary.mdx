...
description: "Introduces the core concepts, data model, and conventions used throughout the TAPP Engine API, including partners, accounts, orders, and webhooks."
---

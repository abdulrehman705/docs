---
title: "Welcome to Tapp Engine"
sidebarTitle: "Introduction"
description: "Overview of the TAPP Engine API for brokerage, trading, and wealth-management workflows, plus platform architecture and environments."
---

Welcome to the **TAPP Engine API** documentation. This site explains how to integrate with the TAPP Engine platform for brokerage, trading, and wealth-management workflows.
...
The TAPP Engine documentation is organized into two main areas:
...
**TAPP Wealth** — Feature-by-feature guides for each product area:
...
All requests are authenticated using your `X-API-Key` and `X-API-Secret` headers. You generate API keys from the TAPP Engine Partner Dashboard or via the API Keys endpoint.
...
1. About TAPP Engine — Understand the platform architecture
